...
if __name__ == "__main__":
    ...
    run_name = f"furutaTorque__{args.exp_name}__{args.seed}__{int(time.time())}"
    
    writer = SummaryWriter(f"furuta_pendulum_tensorboard/{run_name}")
    writer.add_text(
        "hyperparameters",
    ...
    if args.save_model:
        model_path = f"furuta_pendulum_tensorboard/{run_name}/{args.exp_name}.cleanrl_model"
